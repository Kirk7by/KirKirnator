...
namespace ExpertCore
{
    public class TestDATABASE
    {
        public List<Answers> getAnswer() //возвращает список героев и процент ответов на их вопросы
        {
            ...
            ans.Add(new Answers{NameAnswer="Енштейн", TextAnswer="герой такой умный", QantityAnswer=205,ParamsQusttype=qeЕнштейОтветы });
            ...
            ans.Add(new Answers { NameAnswer = "Бетмен", TextAnswer = "герой такой черный", QantityAnswer = 205, ParamsQusttype = qeБетменОтветы });
            ...
            qeГульОтветы.Add(new Questions { NameQestion = "Анимешность", OtvetQuest2 = 0.9, OtvetQuest3 = 0.05, OtvetQuest4 = 0.05 });

            ans.Add(new Answers { NameAnswer = "гуль", TextAnswer = "герой такой анимешный", QantityAnswer = 205, ParamsQusttype = qeГульОтветы });
            return ans;
        }
    }
}
