...
namespace ExpertCore
{
    ...
    {
        public List<Heroes> getAnswer() //возвращает список героев и процент ответов на их вопросы
        {
            List<Questions> qeЕнштейОтветы = new List<Questions>();
            List<Heroes> ans = new List<Heroes>();
            ...
            ans.Add(new Heroes{NameAnswer="Ейнштейн", TextAnswer="герой такой умный", QantityAnswer=30,ParamsQusttype=qeЕнштейОтветы });
            ...
            ans.Add(new Heroes { NameAnswer = "Бетмен", TextAnswer = "герой такой черный", QantityAnswer = 200, ParamsQusttype = qeБетменОтветы });
            ...
            ans.Add(new Heroes { NameAnswer = "гуль", TextAnswer = "герой такой анимешный", QantityAnswer = 49, ParamsQusttype = qeГульОтветы });
            return ans;
        }
    }
}
